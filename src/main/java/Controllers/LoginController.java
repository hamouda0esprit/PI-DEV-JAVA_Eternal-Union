            ...
            if (controller.isLoginSuccessful()) {
                ...
                if (authenticatedUser != null) {
                    ...
                    try {
                        ...
                        // Replace the current scene with the home page
                        Scene homeScene = new Scene(homeRoot);
                        stage.setTitle("LOE - Home");
                        stage.setScene(homeScene);
                        
                        System.out.println("Successfully redirected to home page for user: " + authenticatedUser.getName());
                    } catch (IOException e) {
                                ...
                                if (existingUser != null) {
                                    ...
                                    javafx.application.Platform.runLater(() -> {
                                        ...
                                        try {
                                            ...
                                            FXMLLoader profileLoader = new FXMLLoader(getClass().getResource("/view/Home.fxml"));
